...
def set_req_res_api_route_all_users(route):
    pytest.globalDict['api_endpoint'] = pytest.globalDict['req_res_api_base_url'] + route
...
def set_req_res_api_route_single_user(route):
    ...
    pytest.globalDict['api_endpoint'] = pytest.globalDict['req_res_api_base_url'] + api_route + pytest.globalDict['user_id']
